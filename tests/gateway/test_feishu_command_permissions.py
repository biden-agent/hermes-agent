...
def test_feishu_member_terminal_command_allowlist_is_applied():
    runner = _make_runner(
        admins=["ou_admin"],
        tool_permissions={
            "allowed_toolsets": ["terminal"],
            "allowed_terminal_commands": ["curl"],
        },
    )

    allowed = runner._resolve_effective_terminal_command_allowlist(
        user_config={
            "platforms": {
                "feishu": {
                    "extra": {
...
def test_feishu_admin_terminal_command_allowlist_is_not_applied():
    runner = _make_runner(
        admins=["ou_admin"],
        tool_permissions={
            "allowed_toolsets": ["terminal"],
